...
function pokSearch(etatCourant){
  //console.log("%  ")
  ...
  //const caracters = etatCourant.inputSearch;
  ...
  searchBar.addEventListener('keyup', (e) => {
      ...
      console.log("End")
      etatCourant.pokemon.forEach(poke => {
        const isVisible = poke.Name.toLowerCase().includes(searchString)
